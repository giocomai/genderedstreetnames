...
city_roads_gender %>%  DT::datatable()
```

Unsurprisingly, this is not completely accurate. Let's export this and fix mistakes in an interactive interface.
...
# Do the same with other cities

```{r eval = FALSE}
ro_county_seats <- xml2::read_html(x = "https://en.wikipedia.org/wiki/Counties_of_Romania") %>% 
