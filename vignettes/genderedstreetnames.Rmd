...
## Manually fixing what's not right
...
Among all the streets in Sibiu that are dedicated to a person, it appears that about `r scales::percent(x = city_roads_gender_balance$n[is.na(city_roads_gender_balance$Gender)==FALSE&city_roads_gender_balance$Gender=="Female"]/city_roads_gender_balance$n[is.na(city_roads_gender_balance$Gender)==FALSE&city_roads_gender_balance$Gender=="Male"])` are dedicated to women. 
