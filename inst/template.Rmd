...
tmap::tmap_leaflet(city_map_interactive)
```

Here are all the streets in `r stringr::str_to_title(params$city)`:

```{r CityStreetsTable, message=FALSE, warning=FALSE}
city_roads %>%
